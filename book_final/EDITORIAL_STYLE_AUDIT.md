...
| 04 - Co LLM umí - a co neumí.md | ano | NE | NE | 1 |
| 05 - Mapa modelů.md | ano | NE | ano | 1 |
| 06 - Jak modely porovnávat.md | ano | NE | NE | 1 |
| 07 - Cloud vs. on-prem vs. hybrid.md | ano | NE | ano | 1 |
| 08 - Jak provozovat LLM lokálně.md | ano | NE | NE | 1 |
| 09 - Prompting.md | ano | NE | ano | 1 |
| 10 - Context Engineering.md | ano | NE | NE | 1 |
| 11 - Proč model nezná moje data.md | ano | NE | ano | 1 |
| 12 - RAG - Retrieval-Augmented Generation.md | ano | NE | NE | 2 |
...
| 20 - Coding Agents.md | ano | NE | ano | 1 |
| 21 - AI nad dokumenty a firemními daty.md | ano | ano | NE | 1 |
| 22 - AI pro technické a inženýrské úlohy.md | ano | NE | ano | 1 |
| 23 - Případová studie - AI-assisted analog IC design.md | ano | NE | NE | 1 |
| 24 - Bezpečnost AI.md | ano | NE | ano | 1 |
| 25 - Proč nestačí „máme ChatGPT“.md | ano | NE | NE | 1 |
| 26 - AI readiness.md | ano | NE | NE | 1 |
| 27 - Jak vybírat AI use-cases.md | ano | NE | NE | 1 |
| 28 - Pilot → důkaz → škálování.md | ano | NE | ano | 1 |
| 29 - Lidé a adopce.md | ano | NE | NE | 1 |
