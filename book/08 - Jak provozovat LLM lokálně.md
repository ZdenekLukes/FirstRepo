...
Lokální AI komunita často porovnává výkon podle tokens per second.

Je to užitečné číslo.

Ale může být zavádějící.
...
Na první pohled je A více než třikrát rychlejší.

Ale pokud:

```text
A potřebuje 3 pokusy
B vyřeší úlohu napoprvé
```

může být B reálně rychlejší.

Navíc u agentů často velkou část času zabírá:
...
Model může generovat velmi rychle, ale workflow stejně trvá dvě minuty.

Proto je nejdůležitější metrika:

> **čas od zadání úlohy k ověřenému použitelnému výsledku**
