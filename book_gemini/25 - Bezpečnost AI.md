...
## 25.1 Jaká data posíláme modelu
...
Proto potřebujeme data classification ještě před AI vrstvou.
...
## 25.4 Training on customer data
...
## 25.5 Enterprise smluvní ochrany
...
System prompt ani jiná textová instrukce **není neprolomitelná security boundary**. Je to důležitá behaviorální vrstva, ale prompt injection a nedůvěryhodný obsah mohou model ovlivnit. Proto potřebujeme defense-in-depth:
...
## 25.10 Indirect prompt injection
...
## 25.17 Supply-chain riziko open-source modelů
...
## 25.19 Bezpečnost vs. použitelnost
...
Nejlepší cesta je **progressive trust**.
...
Další kapitola v pořadí se přesune od bezpečnosti k zavádění AI do firmy:
