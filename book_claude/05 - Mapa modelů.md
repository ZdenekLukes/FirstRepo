...
V době tohoto snapshotu je aktuální generací **řada Claude 5** — významnými modely jsou **Claude Sonnet 5** a **Claude Opus 5**.
...
Opus 5 cílí na nejsložitější dlouhotrvající úlohy, kde je důležitá kvalita úsudku a schopnost průběžně kontrolovat vlastní postup.
