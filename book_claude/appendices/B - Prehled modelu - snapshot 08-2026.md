...
| Anthropic | Claude Opus 5 | nejnáročnější knowledge work | cloud | ne | dlouhé a komplexní úlohy | vyšší třída řady Claude 5, kde kvalita převáží cenu |
...
| Cohere | Command A+ | enterprise / RAG / sovereign AI | cloud + private deployment | podle konkrétní varianty | enterprise, multilingual, RAG | zajímavý pro privátní nasazení; **licenci vah před komerčním použitím vždy ověř u zdroje** (starší Command A měl nekomerční licenci) |
